...
public class 案件Service {
	String[] 案件信息 = { "案件名称", "案件概要", "案件場所",
			"担当職種", "所在工程", "作業開始年月日", "作業预计终了年月",
			"作業实际终了年月", "募集人数", "チーム人数", "開発言語", "FrameWork",
			"ツール", "OS", "DB"};
...
//		String 案件名称文件全路径1 = 路径名 + "案件概要" + ".txt";
//		String 案件名称文件全路径2 = 路径名 + "案件場所" + ".txt";
//		String 案件名称文件全路径3 = 路径名 + "担当職種" + ".txt";
//		String 案件名称文件全路径4 = 路径名 + "所在工程" + ".txt";
//		String 案件名称文件全路径5 = 路径名 + "作業開始年月日" + ".txt";
//		String 案件名称文件全路径6 = 路径名 + "作業预计终了年月" + ".txt";
//		String 案件名称文件全路径7 = 路径名 + "作業实际终了年月" + ".txt";
//		String 案件名称文件全路径8 = 路径名 + "募集人数" + ".txt";
//		String 案件名称文件全路径9 = 路径名 + "チーム人数" + ".txt";
//		String 案件名称文件全路径10 = 路径名 + "開発言語" + ".txt";
//		String 案件名称文件全路径11 = 路径名 + "FrameWork" + ".txt";
//		String 案件名称文件全路径12 = 路径名 + "ツール" + ".txt";
//		String 案件名称文件全路径13= 路径名 + "OS" + ".txt";
//		String 案件名称文件全路径14 = 路径名 + "DB" + ".txt";
